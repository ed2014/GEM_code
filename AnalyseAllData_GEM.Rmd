...
workDF %>%
  ...
  ggplot(aes(x= thisHyb , y=CVperc)) +  geom_point() +
  facet_grid( .~ thisSow)
...
#PLot histograms
hg1 <- ggplot(df_maxBio, aes(x=thisSow_n)) + geom_histogram(binwidth=.5, colour="black", fill="white")
hg2 <- ggplot(df_maxBio, aes(x=thisHyb_n)) + geom_histogram(binwidth=.5, colour="black", fill="white")
...
geom_point(aes(colour = factor(thisHyb )) ) +
