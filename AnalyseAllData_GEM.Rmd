...
# Variability of hybrid by sowing date within each pixel (does not include inter-annual variability)
  workDF %>%
...
colnames(si_weather_merged)[7:10] <- c("Hybrid", "Sowing", "Weather", "Interactions")
